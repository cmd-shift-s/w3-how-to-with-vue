<template>
  <page
    ...
    <hr>
    <h2 class="title">Create A Hoverable Dropdown</h2>
    <p>Create a dropdown menu that appears when the user moves the mouse over an element.</p>
    <step no="1" html></step>
